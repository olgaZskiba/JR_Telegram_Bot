...
public class UserInlineKeyboardSource {
    ...
    public InlineKeyboardMarkup getSelectCourseBoardLevelZero() {
        ...
        InlineKeyboardButton secondButton = new InlineKeyboardButton().setText("Купить").setCallbackData("buy.course.level");
    ...
    public InlineKeyboardMarkup getSelectCourseBoardLevelAdvanced() {
        ...
        InlineKeyboardButton forthButton = new InlineKeyboardButton().setText("Купить").setCallbackData("buy.course.level");
    ...
    public InlineKeyboardMarkup getPaymentMethod(){
        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();

        InlineKeyboardButton firstButton = new InlineKeyboardButton().setText("ЕРИП").setCallbackData("erip");
        InlineKeyboardButton secondButton = new InlineKeyboardButton().setText("BEZKASSIRA").setCallbackData("bez.kassira");
        InlineKeyboardButton thirdButton = new InlineKeyboardButton().setText("TRANZOO").setCallbackData("tranzoo");
        InlineKeyboardButton fourthButton = new InlineKeyboardButton().setText("Банковский платеж").setCallbackData("bank.payment");
