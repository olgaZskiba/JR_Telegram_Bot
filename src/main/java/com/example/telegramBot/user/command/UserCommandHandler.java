...
public class UserCommandHandler {
    ...
    public UserCommandHandler(SendBotMessageService sendBotMessageService, TelegramUserService telegramUserService) {
        ...
        commandMap = ImmutableMap.<String, Command>builder()
                ...
                .put(START.getCommandName(), new MainMenuComm(sendBotMessageService, telegramUserService))
                ...
                .put(RETURN_TO_MAIN_MENU.getCommandName(), new MainMenuComm(sendBotMessageService, telegramUserService))
                ...
                .put(STAT.getCommandName(), new StatComm(telegramUserService, sendBotMessageService))
                .put(STOP.getCommandName(), new StopComm(sendBotMessageService, telegramUserService))
                .put(FINISH_AND_SEND.getCommandName(), new FinishSendComm(sendBotMessageService))
                .put(PAYMENT_METHOD.getCommandName(), new PaymentMethodComm(sendBotMessageService))
